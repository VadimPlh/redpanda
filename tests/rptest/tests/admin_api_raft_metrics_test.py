...
class AdminApiRaftStateTest(RedpandaTest):
    ...
    def simple_test(self):
        ...
        assert raft_info["leader_info"]["committed_log_index"] == 0
        assert raft_info["leader_info"]["dirty_log_index"] == 0
    ...
    def controller_test(self):
        ...
        def wait_all_followers_sync():
            ...
            leader_ci = info["leader_info"]["committed_log_index"]
            for follower in info["followers"]:
                if leader_ci != follower["committed_log_index"]:
                    return False
            return True
